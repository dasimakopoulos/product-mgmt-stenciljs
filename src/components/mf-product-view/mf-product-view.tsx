...
export class ProductView {
  ...
  componentWillLoad() {
    this.productList = [
      {
        id: 1,
        productName: 'iPhone Gold 64 GBytes',
        code: 'cat1-0001',
        price: 18.01,
        cartPrice: 0,
        available: 10,
        ...
        id: 2,
        productName: 'Q Stylus Plus Siyah 64 GBytes',
        code: 'cat1-0010',
        price: 129.05,
        cartPrice: 0,
        available: 9,
        ...
        id: 3,
        productName: 'iPhone 11 Pro Silver 64 GBytes',
        code: 'cat1-0008',
        price: 19.78,
        cartPrice: 0,
        available: 11,
        ...
        id: 5,
        productName: 'iPhone 11 Pro Space Gray 64 GBytes',
        code: 'cat1-0009',
        price: 23.05,
        cartPrice: 0,
        available: 10,
